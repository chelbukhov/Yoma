...
contract GoldenUnitToken is MintableToken {
...
contract Crowdsale is Ownable {
  ...
  GoldenUnitToken public token = new GoldenUnitToken();
  ...
  function purchase (uint _valueTokens) public purchaseAlloved {
